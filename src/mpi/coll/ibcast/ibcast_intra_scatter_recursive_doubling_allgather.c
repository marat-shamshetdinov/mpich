 ...
 */
#undef FUNCNAME
#define FUNCNAME MPIR_Ibcast_intra_nbc_scatter_recursive_doubling_allgather
#undef FCNAME
                                                               ...
                                                               MPIR_Request ** request)
{
    ...
    MPIR_SCHED_CREATE_START(MPIR_Ibcast_sched_intra_scatter_recursive_doubling_allgather
